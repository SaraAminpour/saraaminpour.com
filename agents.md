...
- Homepage News button sits beside the primary links and toggles an inline award-card panel beneath the buttons without navigation. The panel presents the four awards listed in the 2026 CV. Keep award names and dates grounded in the CV; it does not identify which specific conference each travel award funded.
